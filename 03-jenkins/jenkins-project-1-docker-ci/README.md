...
Application message:
    ...
    Jenkins CI Pipeline
    Flask Application Running Successfully with Jenkins CI!
...
The Docker Hub access token is stored securely in Jenkins and is not hardcoded inside the Jenkinsfile.
...
The main objective of this project is to understand how Jenkins can automate a Continuous Integration workflow.
...
- Automatically triggered Jenkins from GitHub
- Checked out the application
- Installed dependencies
- Tested the Flask application
- Built the Docker image
- Pushed the Docker image to Docker Hub

The project demonstrates a complete Jenkins-based Docker CI workflow.
